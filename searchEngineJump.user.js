  ...
  function iqxinstart() {
    ...
    var rules = [
      ...
      },
      {
        ...
        fixedTop: 60,
        style:
          "width:1140px;margin:1em auto;z-index: 11;position:sticky;top:70px;",
        insertIntoDoc: {
    ...
    engineList_plus[1] = {
      ...
      engineList: [
        ...
        {
          name: "forfrigg",
          url: "https://forfrigg.com/#gsc.tab=0&gsc.q=%s&gsc.sort=",
          favicon:
        ...
        },
        {
          ...
          url: "https://gen.lib.rus.ec/search.php?req=%s",
          favicon:
    ...
    engineList_plus[2] = {
      ...
      engineList: [
        ...
        {
          name: "盘多多",
          url: "https://www.panduoduo.net/s/name/%s",
          favicon:
        ...
        {
          name: "Pan115",
          url: "https://www.pan115.com/search?key=%s",
          favicon:
    ...
    function addSEJ() {
      ...
      engineList.details.forEach(function (item) {
        ...
        engineList[category].forEach(function (engine) {
          ...
          if (
            getSettingData.HideTheSameLink &&
            matchedRule?.url.test(engineUrl)
          )
            return; // 去掉跳转到当前引擎的引擎
    ...
    SEJsetting.prototype = {
      ...
      addItemBox: function (bool) {
        ...
        newDiv.innerHTML =
          ...
          "</span>" +
          "<br/><br/>" +
          "<span style=''><a target='_blank' style='color:#999;' href='https://greasyfork.org/en/scripts/454280-searchenginejumpplus'>相关使用说明</a></span>" +
          "&nbsp;&nbsp;&nbsp&nbsp&nbsp&nbsp&nbsp;" +
